...
public interface FileService {
     ...
     */
    String uploadAvatar(InputStream inputStream, String contentType) throws PortableException;
     ...
     * @throws PortableException 类型不匹配则抛出
     */
    String uploadImage(InputStream inputStream, String contentType) throws PortableException;
