...
import com.portable.server.struct.impl.FilePartitionHelperImpl;
import com.portable.server.struct.impl.MemPriorityQueueHelper;
...
public abstract class BaseDaoConfig {
    ...
    @Lazy
    @Bean(name = "captchaPartitionHelper")
    public PartitionHelper captchPartitionHelper() {
        return new FilePartitionHelperImpl("captcha");
    }

    @Lazy
    @Bean(name = "problemPartitionHelper")
    public PartitionHelper problemPartitionHelper() {
        return new FilePartitionHelperImpl("problem");
    }
}
